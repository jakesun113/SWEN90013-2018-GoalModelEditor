...
EditorUi.prototype.refresh = function(sizeDidChange)
{
	...
	//Yuwei Bao 
	// double sidebar width
	var effHsplitPosition = Math.max(0, Math.min(this.hsplitPosition, w - this.splitSize - 20)) * 2;
...
EditorUi.prototype.addSplitHandler = function(elt, horizontal, dx, onChange)
{
	...
	{
		// Yuwei Bao
		// change to make hsplit not jump
		var result = parseInt(((horizontal) ? elt.style.left : elt.style.bottom))/2;
...
EditorUi.prototype.createKeyHandler = function(editor)
{
	...
	if (!this.editor.chromeless)
	{
		...
		keyHandler.bindAction(81, false, 'connectionPoints', true); // Ctrl+Shift+Q
