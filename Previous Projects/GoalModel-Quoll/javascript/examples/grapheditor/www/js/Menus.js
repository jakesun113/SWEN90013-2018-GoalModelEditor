...
Menus.prototype.defaultMenuItems = ['file', 'view', 'extras', 'help'];
...
Menus.prototype.init = function()
{
			...
			if (tmp != null)
			{
				...
				promptSpacing(layout.levelDistance, mxUtils.bind(this, function(newValue)
				{
					...
					this.editorUi.executeLayout(function()
		    		{
						...
						console.log(mxUtils.trim(mxUtils.getXml(this.editorUi.editor.getGraphXml())));
				}));
			}
		}), parent);
	...
	this.put('view', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ((this.editorUi.format != null) ? ['formatPanel'] : []).
			concat(['outline', '-', 'pageView', 'pageScale', '-', 'scrollbars', '-',
			        'grid', 'resetView', 'zoomIn', 'zoomOut'], parent));
	})));
	...
	{
		this.addMenuItems(menu, ['new', 'open', '-', 'save', 'saveAs', 'export', '-', 'pageSetup', 'print'], parent);
	})));
