...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		...
		Graph.prototype.cellLabelChanged = function(cell, value, autoSize)
		{
			...
			value = textConverter(cell.style, value);
			this.model.beginUpdate();
			if (singleElementErrorCheck(value, true)){
				try
				{
					if (cell.value != null && typeof cell.value == 'object')
					{
				...
				// Yuwei Bao
				// update sidebar after editing element in the graph
				updateSidebarSingle(cell.id, cell.style, value);
			}else{
				this.model.endUpdate();
				return;
			}
