...
Actions.prototype.init = function()
{
	...
	this.addAction('save', function() { updateHelper(document.getElementById('sidebarTextarea').value , ui, false);ui.saveFile(false); }, null, null, 'Ctrl+S').isEnabled = isGraphEnabled;
	...
	// Arrange actions
	// Yuwei Bao
	//this.addAction('toFront', function() { showHideToggle(ui, ['e', 'h']); }, null, null, 'Ctrl+Shift+F')
	...
	this.addAction('resetView', function()
	{
		...
		// toggle
	this.addAction('all-toggle', function(evt) { showHideToggle(ui, ['s','a','n','c','q','e', 'h']); }, null, null, null);
	this.addAction('emotion-toggle', function(evt) { showHideToggle(ui, ['e', 'h']); }, null, null, null);
	this.addAction('stakeholder-toggle', function(evt) { showHideToggle(ui, ['s', 'a']); }, null, null, null);
	this.addAction('negative-toggle', function(evt) { showHideToggle(ui, ['n']); }, null, null, null);
	this.addAction('quality-toggle', function(evt) { showHideToggle(ui, ['c','q']);}, null, null, null);
	...
	this.addAction('newHelp', function()
	{
		// LATER: Check layers window for initial placement
		this.helpWindow = new HelpWindow(ui, document.body.offsetWidth - 260, 100, 180, 180);
		this.helpWindow.window.setVisible(true);
		ui.fireEvent(new mxEventObject('helpWindow'));
	});

	this.put('about', new Action(mxResources.get('about') + ' Goal Model Editor...', function()
	{
