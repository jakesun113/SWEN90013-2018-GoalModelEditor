...
Toolbar.prototype.init = function()
{
	...
	this.addItems(['all-toggle']);
	this.addItems(['emotion-toggle']);
	this.addItems(['negative-toggle']);
	this.addItems(['quality-toggle']);
	this.addItems(['stakeholder-toggle']);
