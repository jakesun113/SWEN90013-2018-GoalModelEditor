...
mxConnectionHandler.prototype.mouseDown = function(sender, me) {
    ...
    if (
        ...
        this.fireEvent(
            new mxEventObject(mxEvent.START, "state", this.previous)
        );
            ...
            if (this.edgeState != null) {
                ...
                if (this.currentState != null) {
                    if (this.constraintHandler.currentConstraint == null) {
                        var tmp = this.getTargetPerimeterPoint(
                            this.currentState,
                            me
                        );
                ...
                if (this.sourceConstraint == null && this.previous != null) {
                    var next =
                        this.waypoints != null && this.waypoints.length > 0
                            ? this.waypoints[0]
                            : current;
                    var tmp = this.getSourcePerimeterPoint(
                        this.previous,
                        next,
                        me
                    );
    ...
    if (
        ...
        try {
            ...
            if (edge != null) {
                ...
                if (
                    this.isInsertBefore(edge, source, target, evt, dropTarget)
                ) {
                    var index = null;
                    var tmp = source;
                ...
                if (this.waypoints != null && this.waypoints.length > 0) {
                    ...
                    for (var i = 0; i < this.waypoints.length; i++) {
                        ...
                        geo.points.push(
                            new mxPoint(pt.x / s - tr.x, pt.y / s - tr.y)
                        );
                    }
                }
