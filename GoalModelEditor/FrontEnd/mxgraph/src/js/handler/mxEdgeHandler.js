            ...
            if (!this.isSource && !this.isTarget) {
                for (var i = 0; i < this.bends.length; i++) {
                    if (i != this.index) {
                        ...
                        if (
                            bend != null &&
                            mxUtils.contains(bend.bounds, pt.x, pt.y)
                        ) {
                            if (this.index <= mxEvent.VIRTUAL_HANDLE) {
                                points.splice(
                                    mxEvent.VIRTUAL_HANDLE - this.index,
                                    1
                                );
                            } else {
                ...
                if (
                    ...
                    if (src != null) {
                        ...
                        if (
                            c == null ||
                            this.graph.getConnectionPoint(src, c) == null
                        ) {
                            abs[0] = new mxPoint(
                    ...
                    if (trg != null) {
                        ...
                        if (
                            c == null ||
                            this.graph.getConnectionPoint(trg, c) == null
                        ) {
