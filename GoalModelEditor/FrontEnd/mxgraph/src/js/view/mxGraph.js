    ...
    if (mxClient.IS_IE) {
        ...
        mxEvent.addListener(
            ...
            mxUtils.bind(this, function(evt) {
                return (
                    this.isEditing() ||
                    (!this.isMouseDown && !mxEvent.isShiftDown(evt))
                );
            })
        );
    }
            ...
            if (dx < border) {
                ...
                if (extend && old == c.scrollLeft) {
                    if (this.dialect == mxConstants.DIALECT_SVG) {
                        ...
                        var width =
                            Math.max(c.clientWidth, c.scrollWidth) +
                            border -
                            dx;
            ...
            if (dy < border) {
                ...
                if (old == c.scrollTop && extend) {
                    if (this.dialect == mxConstants.DIALECT_SVG) {
                        ...
                        var height =
                            Math.max(c.clientHeight, c.scrollHeight) +
                            border -
                            dy;
                        var canvas = this.view.getCanvas();
...
mxGraph.prototype.sizeDidChange = function() {
    ...
    if (this.container != null) {
        ...
        if (this.minimumGraphSize != null) {
            width = Math.max(
                width,
                this.minimumGraphSize.width * this.view.scale
            );
            height = Math.max(
                height,
        ...
        if (image != null && image.substring(0, 11) == "data:image/") {
            if (image.substring(0, 20) == "data:image/svg+xml,<") {
                ...
                image =
                    ...
                    encodeURIComponent(image.substring(19));
...
mxGraph.prototype.setCellStyleFlags = function(key, flag, value, cells) {
    ...
    if (cells != null && cells.length > 0) {
        if (value == null) {
            var state = this.view.getState(cells[0]);
            var style =
                state != null ? state.style : this.getCellStyle(cells[0]);
                    ...
                    if (state != null) {
                        ...
                        if (geo != null && !this.model.isEdge(cells[i])) {
                            ...
                            if (align == mxConstants.ALIGN_CENTER) {
                                ...
                                geo.y +=
                                    (param - state.y - state.height / 2) / s;
                            } else if (align == mxConstants.ALIGN_BOTTOM) {
    ...
    try {
        for (var i = cells.length - 1; i >= 0; i--) {
            ...
            if (geo != null) {
                ...
                if (children != null && children.length > 0) {
                    var bounds = this.getBoundingBoxFromGeometry(
                        children,
                        true
                    );
                    ...
                    if (
                        ...
                        if (moveGroup) {
                            ...
                            geo.y = Math.round(
                                geo.y + bounds.y - border - top - topBorder
                            );
                        }
                    ...
                    if (g != null) {
                        ...
                        if (state != null && pstate != null) {
                            ...
                            if (this.model.isEdge(clones[i])) {
                                ...
                                var src = this.model.getTerminal(
                                    cells[i],
                                    true
                                );
                                ...
                                var trg = this.model.getTerminal(
                                    cells[i],
                                    false
                                );
    ...
    if (cells != null && cells.length > 0) {
        ...
        try {
            ...
            for (var i = 0; i < cells.length; i++) {
                ...
                var disconnectTerminal = mxUtils.bind(this, function(
                    edge,
                    source
                ) {
                    ...
                    if (geo != null) {
                        ...
                        if (state != null) {
                            ...
                            if (connected) {
                                var dx = tr.x;
                                var dy = tr.y;
                                var parentState = this.view.getState(
                                    this.model.getParent(edge)
                                );

                                if (
                                    parentState != null &&
                                    this.model.isVertex(parentState.cell)
                                ) {
    ...
    if (cells != null && cells.length > 0) {
        ...
        try {
            for (var i = 0; i < cells.length; i++) {
                if (
                    (!checkFoldable ||
                        this.isCellFoldable(cells[i], collapse)) &&
        ...
        try {
            ...
            if (size != null && geo != null) {
                ...
                if (this.isSwimlane(cell)) {
                    var state = this.view.getState(cell);
                    var style =
                        state != null ? state.style : this.getCellStyle(cell);
                ...
                if (!ignoreChildren && !collapsed) {
                    ...
                    if (bounds != null) {
                        ...
                        var width =
                            (bounds.x + bounds.width) / scale - geo.x - tr.x;
                        var height =
                            (bounds.y + bounds.height) / scale - geo.y - tr.y;
    ...
    if (cell != null) {
        ...
        if (!this.model.isEdge(cell)) {
            ...
            if (value != null && value.length > 0) {
                ...
                if (
                    !mxUtils.getValue(style, mxConstants.STYLE_HORIZONTAL, true)
                ) {
                    var tmp = height;
    ...
    if (geo != null) {
        ...
        if (geo.relative && !this.model.isEdge(cell)) {
            ...
            if (this.model.isVertex(parent)) {
                ...
                var style =
                    state != null ? state.style : this.getCellStyle(parent);
        ...
        if (parent != null && parent != this.getDefaultParent()) {
            ...
            if (g != null) {
                ...
                if (this.isSwimlane(parent)) {
                    ...
                    var flipH =
                        mxUtils.getValue(style, mxConstants.STYLE_FLIPH, 0) ==
                        1;
                    var flipV =
                        mxUtils.getValue(style, mxConstants.STYLE_FLIPV, 0) ==
                        1;
    ...
    if (terminalState.shape != null) {
        ...
        if (this.getModel().isVertex(terminalState.cell)) {
            ...
            if (
                ...
                flipH =
                    mxUtils.getValue(terminalState.style, "stencilFlipH", 0) ==
                        1 || flipH;
                flipV =
                    mxUtils.getValue(terminalState.style, "stencilFlipV", 0) ==
                        1 || flipV;
            }
...
mxGraph.prototype.getConnectionPoint = function(vertex, constraint) {
    ...
    if (vertex != null && constraint.point != null) {
        ...
        point = new mxPoint(
            bounds.x + constraint.point.x * bounds.width,
        ...
        if (constraint.perimeter) {
            ...
            if (this.getModel().isVertex(vertex.cell)) {
                ...
                if (vertex.shape != null && vertex.shape.stencil != null) {
                    flipH =
                        mxUtils.getValue(vertex.style, "stencilFlipH", 0) ==
                            1 || flipH;
                    flipV =
                        mxUtils.getValue(vertex.style, "stencilFlipV", 0) ==
                            1 || flipV;
                }
                    ...
                    if (this.model.isEdge(cells[i])) {
                        ...
                        if (geo.relative) {
                            if (
                                ...
                                var tmp = this.getBoundingBoxFromGeometry(
                                    [parent],
                                    false
                                );
            ...
            if (dx == 0 && dy == 0) {
                ...
                if (this.shiftPreview1 != null) {
                    ...
                    if (this.shiftPreview1.parentNode != null) {
                        this.shiftPreview1.parentNode.removeChild(
                            this.shiftPreview1
                        );
                    }
                    ...
                    if (this.shiftPreview2.parentNode != null) {
                        this.shiftPreview2.parentNode.removeChild(
                            this.shiftPreview2
                        );
                    }
...
mxGraph.prototype.getEdges = function(
    ...
    for (var i = 0; i < childCount; i++) {
        ...
        if (isCollapsed || !this.isCellVisible(child)) {
            edges = edges.concat(
                this.model.getEdges(child, incoming, outgoing)
            );
        }
    }
            ...
            if (result == null || result) {
                ...
                if (edgeCount > 0) {
                    for (var i = 0; i < edgeCount; i++) {
                        ...
                        var isSource =
                            this.model.getTerminal(e, true) == vertex;
    ...
    if (
        ...
        if (
            ...
            if (
                ...
                Math.abs(this.lastTouchX - me.getX()) <
                    this.doubleTapTolerance &&
                Math.abs(this.lastTouchY - me.getY()) <
                    this.doubleTapTolerance &&
    ...
    if (!this.isEventIgnored(evtName, me, sender)) {
        ...
        if (
            ...
            this.tapAndHoldValid =
                Math.abs(this.initialTouchX - me.getGraphX()) <
                    this.tolerance &&
