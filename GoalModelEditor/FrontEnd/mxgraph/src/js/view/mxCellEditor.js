        ...
        if (
            ...
            if (isEdge) {
                ...
                if (
                    ...
                    var spacing =
                        parseInt(state.style[mxConstants.STYLE_SPACING] || 2) *
                        scale;
                    var spacingTop =
                        (parseInt(
                            state.style[mxConstants.STYLE_SPACING_TOP] || 0
                        ) +
                    ...
                    var spacingRight =
                        (parseInt(
                            state.style[mxConstants.STYLE_SPACING_RIGHT] || 0
                        ) +
                    ...
                    var spacingBottom =
                        (parseInt(
                            state.style[mxConstants.STYLE_SPACING_BOTTOM] || 0
                        ) +
                    ...
                    var spacingLeft =
                        (parseInt(
                            state.style[mxConstants.STYLE_SPACING_LEFT] || 0
                        ) +
            ...
            if (
                ...
                var tmp =
                    Math.round(
                        this.bounds.width /
                            (document.documentMode == 8 ? scale : scale)
                    ) + this.wordWrapPadding;
            ...
            if (document.documentMode == 8) {
                ...
                this.textarea.style.top =
                    Math.max(
                        ...
                        Math.ceil(
                            (this.bounds.y -
                                m.y *
                                    (this.bounds.height - (oh + 0.5) * scale) +
                                oh * (scale - 1) * 0 +
                                Math.abs(m.y + 0.5) * 1) /
                                scale
                        )
                ...
                this.textarea.style.left =
                    Math.max(
                        0,
                        Math.round(
                            this.bounds.x - m.x * (this.bounds.width - 2)
                        ) + 1
                    ) + "px";
                this.textarea.style.top =
                    Math.max(
...
mxCellEditor.prototype.isLegacyEditor = function() {
    if (mxClient.IS_VML) {
        ...
        if (mxClient.IS_SVG) {
            ...
            if (root != null) {
                absoluteRoot =
                    mxUtils.getCurrentStyle(root).position == "absolute";
            }
        }
