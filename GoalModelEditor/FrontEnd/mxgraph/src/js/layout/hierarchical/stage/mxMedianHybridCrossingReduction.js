        ...
        if (candidateCrossings < currentBestCrossings) {
            ...
            for (var j = 0; j < this.nestedBestRanks.length; j++) {
                ...
                for (var k = 0; k < rank.length; k++) {
                    var cell = rank[k];
                    this.nestedBestRanks[j][
                        cell.getGeneralPurposeVariable(j)
                    ] = cell;
                }
            }
        } else {
        ...
        for (var i = 0; i < model.ranks.length; i++) {
            ...
            for (var j = 0; j < rank.length - 1; j++) {
                ...
                if (j == 0) {
                    ...
                    leftCellAboveConnections = leftCell.getNextLayerConnectedCells(
                        i
                    );
                ...
                rightCellAboveConnections = rightCell.getNextLayerConnectedCells(
                    i
                );
...
mxMedianHybridCrossingReduction.prototype.medianRank = function(
    ...
    for (var i = 0; i < numCellsForRank; i++) {
        ...
        if (downwardSweep) {
            nextLevelConnectedCells = cell.getNextLayerConnectedCells(
                rankValue
            );
        } else {
