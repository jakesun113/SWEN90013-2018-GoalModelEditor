 ...
 */
mxSwimlaneModel.prototype.createInternalCells = function(
    layout,
    vertices,
    internalVertices
) {
        ...
        for (var j = 0; j < conns.length; j++) {
            ...
            if (
                ...
                if (
                    ...
                    var internalEdge = new mxGraphHierarchyEdge(
                        undirectedEdges
                    );
 ...
 */
mxSwimlaneModel.prototype.maxChainDfs = function(
    parent,
    root,
    connectingEdge,
    seen,
            ...
            if (parent != null && edge != null) {
                ...
                if (parentToCellRankDifference > 1) {
                    ...
                    for (var i = edge.minRank + 1; i < edge.maxRank; i++) {
                        ...
                        edge.setGeneralPurposeVariable(
                            i,
                            rankList[i].length - 1
                        );
                    }
 ...
 */
mxSwimlaneModel.prototype.dfs = function(
    parent,
    root,
    connectingEdge,
    visitor,
