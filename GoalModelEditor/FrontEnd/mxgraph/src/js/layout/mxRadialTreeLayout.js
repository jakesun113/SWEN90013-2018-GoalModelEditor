...
mxRadialTreeLayout.prototype.execute = function(parent, root) {
    ...
    for (var i = 0; i < this.row.length; i++) {
        var leftGrad =
            (this.centerX - this.rowMinX[i] - this.nodeDistance) /
            this.rowRadi[i];
        var rightGrad =
            (this.rowMaxX[i] - this.centerX - this.nodeDistance) /
            this.rowRadi[i];
    ...
    for (var i = 0; i < this.row.length; i++) {
        ...
        for (var j = 0; j < this.row[i].length; j++) {
            ...
            var xProportion =
                (vertexBounds.x + vertexBounds.width / 2 - xLeftLimit) /
                fullWidth;
