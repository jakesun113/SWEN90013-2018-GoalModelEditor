                    ...
                    if (node.nodeType == mxConstants.NODETYPE_ELEMENT) {
                        if (!this.processInclude(dec, node, into)) {
                            if (node.nodeName == "separator") {
                                ...
                                var pressedIcon = node.getAttribute(
                                    "pressedIcon"
                                );
                                        ...
                                        if (icon == null) {
                                            ...
                                            for (
                                                ...
                                                if (
                                                    ...
                                                    var lab = child.getAttribute(
                                                        "as"
                                                    );
                                                    var act = child.getAttribute(
                                                        "action"
                                                    );
                                                    into.addActionOption(
                                                        combo,
                                                        lab,
                                                        act
                                                    );
                                            ...
                                            for (
                                                ...
                                                if (
                                                    ...
                                                    option.cellStyle = child.getAttribute(
                                                        "style"
                                                    );
                                                }
                                            }
