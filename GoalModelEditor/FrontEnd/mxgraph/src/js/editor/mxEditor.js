...
mxEditor.prototype.createGraph = function() {
    ...
    // popupmenu items
    graph.popupMenuHandler.factoryMethod = mxUtils.bind(this, function(
        menu,
        cell,
        evt
    ) {
    ...
    graph.connectionHandler.factoryMethod = mxUtils.bind(this, function(
        source,
        target
    ) {
...
mxEditor.prototype.addVertex = function(parent, vertex, x, y) {
    ...
    try {
        ...
        if (vertex != null) {
            ...
            this.fireEvent(
                new mxEventObject(mxEvent.ADD_VERTEX, "vertex", vertex)
            );
        }
    } finally {
        model.endUpdate();
