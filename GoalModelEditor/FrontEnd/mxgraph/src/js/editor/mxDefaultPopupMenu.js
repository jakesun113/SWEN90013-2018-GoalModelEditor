 ...
 */
mxDefaultPopupMenu.prototype.addItems = function(
    editor,
    menu,
    cell,
    evt,
...
mxDefaultPopupMenu.prototype.createConditions = function(editor, cell, evt) {
    ...
    conditions["expandable"] =
        isCell && editor.graph.isCellFoldable(cell, false);
    conditions["collapsable"] =
        isCell && editor.graph.isCellFoldable(cell, true);
