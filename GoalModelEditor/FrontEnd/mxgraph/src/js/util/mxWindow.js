    ...
    if (resizable) {
        if (this.resize == null) {
            ...
            var start = mxUtils.bind(this, function(evt) {
                ...
                this.fireEvent(
                    new mxEventObject(mxEvent.RESIZE_START, "event", evt)
                );
                mxEvent.consume(evt);
            });
            ...
            var dragHandler = mxUtils.bind(this, function(evt) {
                if (startX != null && startY != null) {
                    ...
                    this.fireEvent(
                        new mxEventObject(mxEvent.RESIZE, "event", evt)
                    );
                    mxEvent.consume(evt);
                }
            });
            ...
            var dropHandler = mxUtils.bind(this, function(evt) {
                if (startX != null && startY != null) {
                    ...
                    this.fireEvent(
                        new mxEventObject(mxEvent.RESIZE_END, "event", evt)
                    );
                    mxEvent.consume(evt);
                }
            });
    ...
    var funct = mxUtils.bind(this, function(evt) {
        ...
        if (this.maximize.style.display != "none") {
            if (!maximized) {
                ...
                this.fireEvent(
                    new mxEventObject(mxEvent.MAXIMIZE, "event", evt)
                );
            } else {
                maximized = false;
                ...
                this.fireEvent(
                    new mxEventObject(mxEvent.NORMALIZE, "event", evt)
                );
            }
    ...
    mxEvent.addGestureListeners(
        ...
        mxUtils.bind(this, function(evt) {
            ...
            var dropHandler = mxUtils.bind(this, function(evt) {
                ...
                this.fireEvent(
                    new mxEventObject(mxEvent.MOVE_END, "event", evt)
                );
                mxEvent.consume(evt);
            });
