    ...
    if (this.textEnabled && str != null) {
        ...
        if (this.foEnabled && format == "html") {
            ...
            if (clip) {
                ...
                if (h > 0) {
                    style +=
                        "max-height:" + Math.round(h) + "px;overflow:hidden;";
                }
            }
            ...
            if (
                ...
                div2.style.display = mxClient.IS_QUIRKS
                    ? "inline"
                    : "inline-block";
