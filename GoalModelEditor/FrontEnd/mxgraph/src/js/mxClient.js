...
if (typeof mxImageBasePath != "undefined" && mxImageBasePath.length > 0) {
    ...
    if (mxImageBasePath.substring(mxImageBasePath.length - 1) == "/") {
        mxImageBasePath = mxImageBasePath.substring(
            0,
            mxImageBasePath.length - 1
        );
    }
...
if (mxClient.IS_VML) {
    if (mxClient.IS_SVG) {
        ...
        if (mxLoadStylesheets) {
            mxClient.link(
                "stylesheet",
                mxClient.basePath + "/css/explorer.css"
            );
        }
...
if (
    ...
    mxClient.include(
        mxClient.basePath +
            "/js/layout/hierarchical/model/mxGraphHierarchyNode.js"
    );
    mxClient.include(
        mxClient.basePath +
            "/js/layout/hierarchical/model/mxGraphHierarchyEdge.js"
    );
    mxClient.include(
        mxClient.basePath +
            "/js/layout/hierarchical/model/mxGraphHierarchyModel.js"
    );
    mxClient.include(
    ...
    mxClient.include(
        mxClient.basePath +
            "/js/layout/hierarchical/stage/mxMinimumCycleRemover.js"
    );
    mxClient.include(
        mxClient.basePath +
    ...
    mxClient.include(
        mxClient.basePath +
            "/js/layout/hierarchical/stage/mxSwimlaneOrdering.js"
    );
    mxClient.include(
