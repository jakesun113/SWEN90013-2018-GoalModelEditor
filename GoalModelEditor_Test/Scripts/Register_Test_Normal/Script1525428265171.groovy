...
WebUI.setText(findTestObject('RegisterSeries/Page_Registration/input_username'), 'username4')

WebUI.setText(findTestObject('RegisterSeries/Page_Registration/input_lastname'), 'lastname4')

WebUI.setText(findTestObject('RegisterSeries/Page_Registration/input_firstname'), 'firstname4')
...
WebUI.setText(findTestObject('RegisterSeries/Page_Registration/input_confirmPassword'), '123456')
